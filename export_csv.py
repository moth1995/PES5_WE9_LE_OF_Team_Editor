...
def create_csv(filename):
    ...
    try:
        with open(file, 'w',newline='', encoding='utf-8') as f:
            ...
            "CONDITION / FITNESS", "STAT X" ,"DRIBBLING","TACTIAL DRIBBLE","POST PLAYER","POSITIONING","REACTION","LINES","MIDDLE SHOOTING","SCORING",
            ...
            "DROP KICK STYLE","AGE","WEIGHT","NATIONALITY","CALLNAME ID", "STAT EDITED"])
        return file
